...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'dni'=>'string|required|unique:products|max:10',
            'ruc'=>'string|required|unique:products|max:10',
            'address'=>'string|required|max:255',
            'phone'=>'string|required|unique:products|max:10',
            'email'=>'string|required|unique:products|max:255|email:rfc,dns',
        ];
    }
